...
\emph{GPT-2}~\cite{radfordLanguageModelsAre,OpenaiGpt22019}
...
if we normalize the data) to real numbers in the interval from 0 to
512 inclusively (assuming our currently supplied metadata; more
