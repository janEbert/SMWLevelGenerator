...
We noticed a loss in speed for data of very high dimensionality
(over~2D), meaning the transformer models still outperformed LSTMs in
lower dimensionalities but were less efficient for more
high-dimensional data. We assume this is due to implementation
